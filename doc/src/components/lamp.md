...
!!! note
    ...
    directly to consumers but should be placed behind a [webgateway](../components/webgateway.md#nixos-webgateway).
...
The Apache server listens on the [SRV interface](../infrastructure/networking/networking.md#logical-networks) only.
