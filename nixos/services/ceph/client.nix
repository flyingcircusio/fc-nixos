  ...
  options = {
    ...
    flyingcircus.services.ceph = {
      ...
      allMergedSettings = lib.mkOption {
        ...
        description = ''
          Contains all properly merged settings used for generating the ceph.ini config file.
      ...
      client = {
        ...
        package = lib.mkOption {
          type = lib.types.package;
          description =
            "Main ceph package to be used on the system and to be put into PATH. "
    ...
    (lib.mkIf cfg.client.enable {
      ...
      environment.etc."ceph/ceph.conf".text =
        lib.generators.toINI { }
          config.flyingcircus.services.ceph.allMergedSettings;
      ...
      services.logrotate.settings.ceph-client = {
        files = [ "/var/log/ceph/client.log" ];
        rotate = "30";
