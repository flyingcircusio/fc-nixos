  ...
  config = lib.mkMerge [
    (lib.mkIf role.enable {
      ...
      flyingcircus.services.sensu-client.checks = {
        radosgw_probe_object_direct = {
          notification = "Probe object (/rgw-monitoring/probe) not OK.";
          command = "check_http -u /rgw-monitoring/probe -H localhost:7480 -m 1000000:1500000 -w 5 -c 10";
        };
        radosgw_probe_object_via_nginx = {
          notification = "Probe object (/rgw-monitoring/probe) not OK.";
          command = "check_http -u /rgw-monitoring/probe -H ${role.domain} -m 1000000:1500000 -w 5 -c 10 -f follow";
        };
      };
