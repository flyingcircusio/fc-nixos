...
let
  ...
  cfgService = config.flyingcircus.services.graylog;
  fclib = config.fclib;
  glAPIHAPort = 8002;
  gelfTCPHAPort = 12201;
  ...
  syslogInputPort = cfgService.syslogInputPort;
  gelfTCPGraylogPort = cfgService.gelfTCPGraylogPort;
  beatsTCPGraylogPort = cfgService.beatsTCPGraylogPort;
