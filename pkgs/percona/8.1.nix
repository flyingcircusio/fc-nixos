...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "https://www.percona.com/downloads/Percona-Server-8.1/Percona-Server-${finalAttrs.version}/source/tarball/percona-server-${finalAttrs.version}.tar.gz";
    hash = "sha256-m4XFDMLnDPvbhtpv8qcjVBNmP4YZIVpaVYMdoMPw2NM=";
  };
  ...
  cmakeFlags = [
    ...
    # TODO: decide whether to offer tcmalloc or jemalloc again
    #"-DWITH_JEMALLOC=1"
    "-DWITH_SYSTEMD=1"
  ...
  passthru = {
    ...
    # TODO when upstreaming: adapt NixOS tests
