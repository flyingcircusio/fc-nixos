...
// {
  ...
  open-webui = super.open-webui.override {
    python3Packages =
      (self.python3.override {
        packageOverrides = python-self: python-super: {
          langchain = python-super.langchain.overridePythonAttrs rec {
            version = "0.3.72";
            ...
            build-system = [ python-self.pdm-backend ];
            buildInputs = [ self.bash ];
            disabledTests = [
              "test_table_info"
          ...
          langchain-core = python-super.langchain-core.overridePythonAttrs rec {
            version = "0.3.72";
            src = fetchFromGitHub {
              owner = "langchain-ai";
              repo = "langchain";
          ...
          langchain-tests = python-super.langchain-tests.overridePythonAttrs rec {
            version = "0.3.21";
            src = fetchFromGitHub {
              owner = "langchain-ai";
              repo = "langchain";
          ...
          langchain-text-splitters = python-super.langchain-text-splitters.overridePythonAttrs rec {
            version = "0.3.11";
            src = fetchFromGitHub {
              owner = "langchain-ai";
              repo = "langchain";
