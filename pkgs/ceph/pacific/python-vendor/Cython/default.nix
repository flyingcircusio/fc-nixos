...
in buildPythonPackage rec {
  ...
  patches = [
    ...
    # setuptools >= 74 has removed msvcc support, which triggers when trying to
    # query the old vendored numpy via its distutils interface. Don't do that.
    ./numpy-no-distutils.patch
  ];
