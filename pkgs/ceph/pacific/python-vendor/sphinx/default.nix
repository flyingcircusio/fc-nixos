...
buildPythonPackage rec {
  ...
  disabledTests = [
    # FIXME: these fail for the FCIO ceph forward porting vendoring process.
    # for now, continue while ignoring these failures – a docs generator
    # hopefully isn't load-bearing for Ceph itself
    "test_html_code_role"
    "test_latex_code_role"
    "test_literal_include_linenos"
    "test_linenothreshold"
    "test_build_sphinx"
    "test_build_sphinx_multiple_builders"
    "test_build_sphinx_with_nonascii_path"
    "test_build_sphinx_warning_return_zero_status"
