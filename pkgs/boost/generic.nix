        ...
        [
          ...
          "architecture=${
            if stdenv.hostPlatform.isMips64 then
              if versionOlder version "1.78" then "mips1" else "mips"
...
stdenv.mkDerivation {
  ...
  patches =
    ...
    ++ optional (versionAtLeast version "1.61" && versionOlder version "1.71") (fetchpatch {
    ...
    ++ optional (versionAtLeast version "1.65" && versionOlder version "1.67") (fetchpatch {
