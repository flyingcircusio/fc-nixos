{
  ...
  kubeclient = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1a22jqsby3xgq1bl9pznps7gagcmyqz7w73qh0aqmzxa7pfhjviv";
      type = "gem";
    };
    version = "2.5.2";
  };
  ...
  sensu-plugins-kubernetes = {
    dependencies = ["activesupport" "kubeclient" "sensu-plugin"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0w99439p0d320ma8lvlqnmwrgs7czni4r22myka073917zlsa6f7";
      type = "gem";
    };
    version = "4.0.0";
  };
